...
const featuredProjectDefinitions: LocalizedProjectDefinition[] = [
  {
    ...
    liveUrl: 'https://valhalla.eclipse-forge.ru',
  ...
  },
  {
    ...
    liveUrl: 'https://rent.eclipse-forge.ru',
    ...
    projects: [
      {
        ...
        liveUrl: 'https://hub.eclipse-forge.ru',
      ...
      },
      {
        ...
        liveUrl: 'https://fitness.eclipse-forge.ru',
      ...
      },
      {
        ...
        liveUrl: 'https://interview.eclipse-forge.ru',
      ...
      },
      {
        ...
        liveUrl: 'https://shotforge.eclipse-forge.ru',
      ...
      },
      {
        ...
        liveUrl: 'https://educator.eclipse-forge.ru',
      ...
      },
      {
        ...
        liveUrl: 'https://text2image.eclipse-forge.ru',
      ...
      {
        title: 'Eclipse DnD Forge',
        systemType: localized('AI CAMPAIGN MANAGER', 'AI CAMPAIGN MANAGER'),
        status: 'live',
        description: localized(
          'AI-менеджер настольных кампаний: карта мира, таймлайн, генерация NPC и квестов через мультиагентный living-world loop. 4 типа AI-агентов поверх форка VisualStoryWriting.',
          'An AI tabletop campaign manager: world map, timeline, NPC and quest generation through a multi-agent living-world loop. Four AI agent types on top of a VisualStoryWriting fork.',
        ),
        tech: ['React', 'TypeScript', 'Vite', 'OpenAI', 'React Flow', 'Slate', 'Zustand'],
        result: localized(
          'Живой мир кампании, который агенты достраивают сами между сессиями.',
          'A living campaign world that agents keep building between sessions.',
        ),
        signal: localized('19 продуктовых слайсов, 4 AI-агента, 3 провайдера, persistent loop.', '19 product slices, 4 AI agents, 3 providers, persistent loop.'),
        tags: localized(['AI-агенты', 'нарратив', 'генерация мира'], ['AI agents', 'narrative', 'world generation']),
        ecosystemTags: localized(['AI', 'multi-agent', 'нарратив'], ['AI', 'multi-agent', 'narrative']),
        liveUrl: 'https://pavelhopson.github.io/eclipse-dnd-forge/',
        repoUrl: 'https://github.com/PavelHopson/eclipse-dnd-forge',
        image: projectImage('eclipse-dnd-forge', 'dnd-forge', 'Eclipse DnD Forge preview', 'center top'),
      },
    ],
  },
  {
    ...
    projects: [
      ...
      {
        title: 'Eclipse Chat',
        systemType: localized('SELF-HOSTED ПЛАТФОРМА', 'SELF-HOSTED PLATFORM'),
        status: 'live',
        description: localized(
          'Self-hosted коммуникационное ядро: серверы, каналы, сообщения и realtime на одном стеке. Operator-friendly альтернатива Discord, развёрнутая в проде, а не демо.',
          'A self-hosted communication core: servers, channels, messages and realtime on a single stack. An operator-friendly Discord alternative running in production, not a demo.',
        ),
        tech: ['React 19', 'TypeScript', 'Fastify', 'Socket.io', 'PostgreSQL', 'MinIO'],
        result: localized(
          'Рабочая realtime-платформа с ролями, инвайтами и файлами под полным контролем.',
          'A working realtime platform with roles, invites and files under full control.',
        ),
        signal: localized('LIVE в проде с 12.05.2026, server / member / invite end-to-end.', 'Live in production since 12.05.2026, server / member / invite end-to-end.'),
        tags: localized(['realtime', 'self-hosted', 'роли и инвайты'], ['realtime', 'self-hosted', 'roles and invites']),
        ecosystemTags: localized(['платформа', 'realtime', 'self-hosted'], ['platform', 'realtime', 'self-hosted']),
        liveUrl: 'https://app.star-crm.ru/eclipse-chat/',
        repoUrl: 'https://github.com/PavelHopson/eclipse-chat',
        image: projectImage('eclipse-chat', 'eclipse-chat', 'Eclipse Chat platform preview', 'center top'),
      },
      {
        title: 'Lead Sniper: CAT Analytics',
        systemType: localized('B2B-АНАЛИТИКА', 'B2B ANALYTICS'),
        status: 'live',
        description: localized(
          'Аналитическая система для исследования рынка переводческих услуг: поиск и квалификация компаний с выручкой 100M+, анализ проникновения CAT-инструментов (Trados, MemoQ, Smartcat) и AI-инсайты через Gemini.',
          'An analytics system for the translation-services market: finding and qualifying companies with 100M+ revenue, CAT-tool penetration analysis (Trados, MemoQ, Smartcat) and AI insights via Gemini.',
        ),
        tech: ['React 19', 'TypeScript', 'Recharts', 'Gemini 2.5 Flash', 'Vite'],
        result: localized(
          'Квалифицированный pipeline компаний вместо ручного ресёрча по рынку.',
          'A qualified company pipeline instead of manual market research.',
        ),
        signal: localized('Скоринг по выручке + penetration-анализ CAT-инструментов с AI-инсайтами.', 'Revenue scoring plus CAT-tool penetration analysis with AI insights.'),
        tags: localized(['B2B research', 'market analytics', 'lead scoring'], ['B2B research', 'market analytics', 'lead scoring']),
        ecosystemTags: localized(['аналитика', 'AI', 'lead-gen'], ['analytics', 'AI', 'lead-gen']),
        repoUrl: 'https://github.com/PavelHopson/Lead-Sniper-CAT-Analytics',
        image: projectImage('lead-sniper', 'lead-sniper-cat-analytics', 'Lead Sniper CAT Analytics preview', 'center top'),
      },
    ],
  },
  {
    ...
    projects: [
      ...
      {
        title: 'KML Field API',
        systemType: localized('ГЕО REST API', 'GEO REST API'),
        status: 'live',
        description: localized(
          'REST API на .NET для работы с геоданными полей из KML: парсинг полигонов, расчёт площадей, расстояний (Haversine) и определение принадлежности точки полю (ray casting).',
          'A .NET REST API for KML field geodata: polygon parsing, area and distance calculation (Haversine) and point-in-field detection (ray casting).',
        ),
        tech: ['.NET 9', 'ASP.NET Core', 'Swagger', 'KML'],
        result: localized(
          'Геометрия полей как API: площади, расстояния и принадлежность точки.',
          'Field geometry as an API: areas, distances and point membership.',
        ),
        signal: localized('Haversine + ray casting, OpenAPI-документация из коробки.', 'Haversine + ray casting, OpenAPI docs out of the box.'),
        tags: localized(['geo API', '.NET', 'геометрия'], ['geo API', '.NET', 'geometry']),
        ecosystemTags: localized(['backend', '.NET', 'geo'], ['backend', '.NET', 'geo']),
        repoUrl: 'https://github.com/PavelHopson/KmlApiApp',
        image: projectImage('kml-api', 'kmlapiapp', 'KML Field API preview', 'center'),
      },
      {
        title: 'AdService',
        systemType: localized('ГЕО-ПОИСК API', 'GEO SEARCH API'),
        status: 'live',
        description: localized(
          'Minimal API на .NET для поиска рекламных площадок по локации с иерархией: запрос по городу возвращает также площадки уровня области и страны.',
          'A .NET Minimal API for location-based ad-placement search with hierarchy: a city query also returns region- and country-level placements.',
        ),
        tech: ['.NET 9', 'Minimal API', 'Swagger'],
        result: localized(
          'Иерархический гео-поиск площадок одним запросом.',
          'Hierarchical geo search of placements in a single request.',
        ),
        signal: localized('Город → область → страна в одном ответе, OpenAPI.', 'City → region → country in one response, OpenAPI.'),
        tags: localized(['geo search', '.NET', 'minimal API'], ['geo search', '.NET', 'minimal API']),
        ecosystemTags: localized(['backend', '.NET', 'geo'], ['backend', '.NET', 'geo']),
        repoUrl: 'https://github.com/PavelHopson/AdService',
        image: projectImage('ad-service', 'adservice', 'AdService preview', 'center'),
      },
    ],
  },
  {
    id: 'frontend-craft',
    eyebrow: localized('Фронтенд и ремесло', 'Frontend and craft'),
    title: localized('Витрины и интерфейсы, доведённые до лоска', 'Surfaces and interfaces polished to a finish'),
    description: localized(
      'Небольшие проекты, где важна чистота фронтенда: анимации, адаптивность, тёмные темы и аккуратная подача. Они показывают планку качества интерфейса вне крупных систем.',
      'Smaller projects where front-end craft matters: animation, responsiveness, dark themes and clean presentation. They show the interface quality bar outside the large systems.',
    ),
    projects: [
      {
        title: 'CineMate',
        systemType: localized('ПОИСК ФИЛЬМОВ', 'MOVIE FINDER'),
        status: 'live',
        description: localized(
          'SPA для поиска фильмов на OMDb API: рейтинги, описания, избранное, светлая/тёмная тема и офлайн-режим.',
          'A movie-search SPA on the OMDb API: ratings, descriptions, favorites, light/dark theme and an offline mode.',
        ),
        tech: ['JavaScript', 'Vite', 'OMDb API'],
        result: localized('Быстрый поиск фильмов с избранным и офлайн-кэшем.', 'Fast movie search with favorites and an offline cache.'),
        signal: localized('SPA с темами, избранным и офлайн-режимом.', 'SPA with theming, favorites and offline mode.'),
        tags: localized(['SPA', 'OMDb', 'офлайн'], ['SPA', 'OMDb', 'offline']),
        liveUrl: 'https://pavelhopson.github.io/cinemate-movie-finder',
        repoUrl: 'https://github.com/PavelHopson/cinemate-movie-finder',
        image: projectImage('cinemate', 'cinemate-movie-finder', 'CineMate movie finder preview', 'center top'),
      },
      {
        title: 'Modern 2048',
        systemType: localized('ИГРА-ГОЛОВОЛОМКА', 'PUZZLE GAME'),
        status: 'live',
        description: localized(
          'Классическая 2048 с современным дизайном, плавными анимациями и адаптивом под десктоп, планшет и телефон.',
          'Classic 2048 with a modern design, smooth animations and a layout adaptive to desktop, tablet and phone.',
        ),
        tech: ['JavaScript', 'Vite', 'SASS'],
        result: localized('Отзывчивая игра с плавной анимацией на любом экране.', 'A responsive game with smooth animation on any screen.'),
        signal: localized('Жесты, темы и адаптив без фреймворка.', 'Gestures, theming and responsiveness with no framework.'),
        tags: localized(['игра', 'анимации', 'адаптив'], ['game', 'animation', 'responsive']),
        liveUrl: 'https://pavelhopson.github.io/modern-2048/',
        repoUrl: 'https://github.com/PavelHopson/modern-2048',
        image: projectImage('modern-2048', '2048', 'Modern 2048 preview', 'center top'),
      },
      {
        title: 'Dark Roast Coffee',
        systemType: localized('ПРЕМИАЛЬНЫЙ ЛЕНДИНГ', 'PREMIUM LANDING'),
        status: 'live',
        description: localized(
          'Премиальный лендинг кофейни в тёмной стилистике: выверенная типографика, анимации и адаптивная подача бренда.',
          'A premium coffee-shop landing in a dark aesthetic: refined typography, animation and a responsive brand presentation.',
        ),
        tech: ['HTML5', 'Tailwind CSS', 'Cloudflare Pages'],
        result: localized('Премиальный бренд-лендинг с вниманием к деталям.', 'A premium brand landing with attention to detail.'),
        signal: localized('Тёмная стилистика, типографика и адаптив.', 'Dark aesthetic, typography and responsiveness.'),
        tags: localized(['лендинг', 'бренд', 'премиум'], ['landing', 'brand', 'premium']),
        liveUrl: 'https://dark-roast-coffee.pages.dev/pages/homepage.html',
        repoUrl: 'https://github.com/PavelHopson/dark_roast_coffee',
        image: projectImage('dark-roast-coffee', 'dark_roast_coffee', 'Dark Roast Coffee landing preview', 'center top'),
      },
    ],
  },
];
