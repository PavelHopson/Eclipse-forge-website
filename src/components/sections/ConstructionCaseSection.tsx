...
const COPY: Record<Locale, Copy> = {
  ru: {
    eyebrow: 'Как работает заказ · Строительные операции',
    title: 'Стройка живёт в Excel,',
    titleAccent: 'WhatsApp и звонках.',
    description:
      'Сайт принимает заявку. AI её структурирует. Менеджер видит готовую карточку. Логист — маршрут. Договор формируется и подписывается онлайн. Руководитель видит статус. Это не просто сайт — это полный процесс работы с заказом.',
    flow: [
      'Заявка с сайта',
