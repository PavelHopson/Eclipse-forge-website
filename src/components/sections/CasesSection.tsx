...
> = {
  ru: {
    ...
    featuredTitle: 'Шесть систем — и одна кинематографическая лаборатория.',
    featuredDescription: 'Рабочие контуры исполнения дополнены атрибутированным исследованием scroll-cinema.',
