              ...
              <div className="flex items-center gap-4 flex-wrap">
                {project.liveUrl && (
                  <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full border text-[12px] sm:text-[13px] font-medium font-display transition-all duration-400 hover:shadow-[0_0_20px_rgba(107,163,255,0.08)]"
                ...
                <a href={project.repoUrl} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full border text-[12px] sm:text-[13px] font-display transition-all duration-400 hover:border-[var(--text-3)] hover:text-[var(--text-2)]"
