...
const impactCopy: Record<Locale, ImpactCopy> = {
  ru: {
    ...
    description:
      'Когда за экраном есть продуманная логика, бизнес получает не просто интерфейс, а рабочую систему: меньше ручной нагрузки, меньше ошибок и больше контроля.',
    signalLabel: 'эффект',
    cards: [
      {
        index: '01',
      ...
      },
      {
        ...
        description: 'Данные быстрее превращаются в действие: меньше ожидания между событием, анализом и следующим шагом.',
        signal: 'data -> action',
      },
      {
        index: '04',
