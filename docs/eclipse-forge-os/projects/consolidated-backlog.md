...
| S | Independently review the Growth invariant fixture | Pavel or designated reviewer | [Review packet](../security/growth-invariant-review-packet.md) | Green CI is mistaken for authorization | Record `request_changes` or `reviewed_with_constraints` with reviewer, UTC timestamp and rationale; do not bundle v4 or deploy approval |
