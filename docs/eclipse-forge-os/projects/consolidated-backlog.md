...
| M | Map Growth security invariants to runtime negative tests | Chat + AI Hub owners | Current invariant fixture | Paper control diverges from runtime | Mapped: `INV-001` covered; `INV-002/003` partial with four explicit `MISSING-` tests in the [evidence map](../security/growth-runtime-test-evidence.md) |
